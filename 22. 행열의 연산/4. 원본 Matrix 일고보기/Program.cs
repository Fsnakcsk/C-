...
namespace Lec14
{
    ...
    class TestMatrix
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("2 차원 배열을 두 개를 입력해 주세용:");
            Console.Write("행 값은 얼마인가용? ");
            m = readInt();
            Console.Write("열 값은 얼마인가용? ");
            n = readInt();
            Console.WriteLine("첫번째 배열 A에 들어갈 데이터를 쳐 주세용:");
            ...
            Console.WriteLine("두번째 배열 B에 들어갈 데이터를 쳐 주세용:");
            ...
            Console.WriteLine(n + "행 3열 짜리 배열에 들어갈 데이터를 쳐 주세용:");
